...
#include "src/Actor/Object/GameCamera/GameCamera.h"
#include "src/Manager/SnowEnemyManager/SnowEnemyManager.h"
#include "src/Actor/Object/Item/SnowBall/SnowBall.h"
#include "src/Manager/SnowBallManager/SnowBallManager.h"
#include "src/Manager/GhostEnemyManager/GhostEnemyManager.h"
#include "src/Manager/MushroomEnemyManager/MushroomEnemyManager.h"
#include "src/Actor/Character/Enemy/GolemEnemy/GolemEnemy.h"
#include "src/Scene/InGame/Game.h"
...
void GameLoad::Update()
{
	...
	m_dropItemsManager = NewGO<DropItemsManager>(0, "dropItemsManager");
