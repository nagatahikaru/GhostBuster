...
void MushroomEnemy::Update()
{
	...
	Tach(*m_mushroomCollisionObject, m_mushroomController,false,&m_itemTypeMushroom);
	Move();
...
void MushroomEnemy::Atk()
{
	...
	Tach(*m_mushroomCollisionObject, m_mushroomController, true, &m_itemTypeMushroom);
}
